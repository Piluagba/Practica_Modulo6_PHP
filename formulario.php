...
<html>
    ...
    <body>
        ...
        <label for="Nombre">Nombre<span><em></em></span></label><br>
        <input type="text" name="Nombre" class="form-input" required maxlength="20"/>
        
        <br>

        <label for="Apellido">Apellido<span><em>(requerido)</em></span></label><br>
        <input type="text" name="Apellido" class="form-input" required maxlength="20"/>
        
        <br>

        <label for="Email">Email<span><em>(requerido)</em></span></label><br>
        <input type="Email" name="Email" class="form-input" required maxlength="20"/>
...
if (empty($Nombre) || empty($Apellido) || empty($Email)) {
    echo "<br>Necesario completar todos los campos.";
    return;
}
